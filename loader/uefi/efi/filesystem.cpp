...
using EFI_FILE_OPEN = EFIAPI EFI_STATUS (*)(EFI_FILE_PROTOCOL * self,
...
auto EFI_FILE_INFO_ID = EFI_GUID{ 0x09576e92, 0x6d3f, 0x11d2, { 0x8e, 0x39, 0x00, 0xa0, 0xc9, 0x69, 0x72, 0x3b } };
...
using EFI_FILE_GET_INFO = EFIAPI EFI_STATUS (*)(EFI_FILE_PROTOCOL * self,
    EFI_GUID * info_type,
...
using EFI_SIMPLE_FILE_SYSTEM_PROTOCOL_OPEN_VOLUME = EFIAPI EFI_STATUS (*)(EFI_SIMPLE_FILE_SYSTEM_PROTOCOL * self,
